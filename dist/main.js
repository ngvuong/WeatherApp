...
function parseWeather(data) {
  ...
  const forecast = data.weekWeather.daily.reduce((acc, day) => {
    const obj = { day: (0,date_fns__WEBPACK_IMPORTED_MODULE_1__["default"])(day.dt * 1000, "EEEE"), temp: day.temp };
