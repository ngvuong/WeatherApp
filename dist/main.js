...
function parseWeather(data) {
  ...
  const today = (0,date_fns__WEBPACK_IMPORTED_MODULE_1__["default"])(new Date(), "MMM-d");
  const forecast = data.weekWeather.daily.reduce((acc, day) => {
    const targetDay = (0,date_fns__WEBPACK_IMPORTED_MODULE_1__["default"])(day.dt * 1000, "MMM-d");
    if (targetDay !== today && acc.length < 7) {
      const obj = {
        day: (0,date_fns__WEBPACK_IMPORTED_MODULE_1__["default"])(day.dt * 1000, "EEEE"),
        temp: day.temp,
      };
      acc.push(obj);
    }
