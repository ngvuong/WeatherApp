...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "windDegToDirection": () => (/* binding */ windDegToDirection)
/* harmony export */ });
function windDegToDirection(d) {
  d = d % 360;
...
/* harmony import */ var _conversion__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./conversion */ "./src/conversion.js");
...
function parseWeather(data) {
  ...
  const windDirection = (0,_windDir__WEBPACK_IMPORTED_MODULE_0__.windDegToDirection)(windDeg);

  // Parse 7 day data for ease of access
  const today = (0,date_fns__WEBPACK_IMPORTED_MODULE_2__["default"])(new Date(), "MMM-d");
  const forecast = data.weekWeather.daily.reduce((acc, day) => {
    const targetDay = (0,date_fns__WEBPACK_IMPORTED_MODULE_2__["default"])(day.dt * 1000, "MMM-d");
    if (targetDay !== today && acc.length < 7) {
      const obj = {
        day: (0,date_fns__WEBPACK_IMPORTED_MODULE_2__["default"])(day.dt * 1000, "EEEE"),
        temp: day.temp,
      };
      acc.push(obj);
    }
...
(async function displayWeather() {
  ...
  function setDisplay(data) {
    ...
    dayDisplay.innerHTML = `<div class="current-forecast">
      ...
      <div class="main-temp"><span>${(0,_conversion__WEBPACK_IMPORTED_MODULE_1__.convert)(
        data.minTemp,
        units
      )}°</span> <span>${(0,_conversion__WEBPACK_IMPORTED_MODULE_1__.convert)(data.temp, units)}°</span> <span>${(0,_conversion__WEBPACK_IMPORTED_MODULE_1__.convert)(
      data.maxTemp,
      units
    )}°</span></div>
    ...
    forecast.forEach((day) => {
      ...
      <div>${(0,_conversion__WEBPACK_IMPORTED_MODULE_1__.convert)(day.temp.day, units)}°</div>
      <div class="min-max"><span>L:${(0,_conversion__WEBPACK_IMPORTED_MODULE_1__.convert)(
        day.temp.min,
        units
      )}° </span><span>H:${(0,_conversion__WEBPACK_IMPORTED_MODULE_1__.convert)(day.temp.max, units)}°</span></div>`;
